...
public class Lambda04 {
    ...
    public static void main(String[] args) {
        ...
        Universite itu=new Universite("istanbul teknik ","matematik",622,82);
        Universite istanbul=new Universite("istanbul ","hukuk",1453,71);
        Universite marmara=new Universite("Marmara univeristesi","bilgisayar muhendisi",1071,77);
    ...
    public static boolean notOrt74Buyuk(List<Universite> unv) {
        ...
        return unv.
                stream().
                anyMatch(t->t.getNotOrt()>74);//hic var mi bak
        //allMatch yazarsan hepsi buyuk mu ona bakar, bir tane bile kucukse false doner
    }
